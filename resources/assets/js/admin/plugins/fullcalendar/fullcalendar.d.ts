...
declare module 'fullcalendar/BusinessHourSimulation' {
	export class Default {
	    rawComplexDef: any;
	    calendar: any;
...
declare module 'fullcalendar/Calendar' {
	...
	import BusinessHourSimulation from 'fullcalendar/BusinessHourSimulation';
	import EventSource from 'fullcalendar/EventSource';
	...
	export class Default {
	    ...
	    businessHourSimulation: BusinessHourSimulation;
	    loadingLevel: number;
...
declare module 'fullcalendar/DateProfileSimulation' {
	import * as moment from 'moment';
	import UnzonedRange from 'fullcalendar/UnzonedRange';
	export class Default {
	    _view: any;
...
declare module 'fullcalendar/DateComponent' {
	...
	export abstract class Default extends Component {
	    ...
	    renderBusinessHours(businessHourSimulation: any): void;
...
declare module 'fullcalendar/View' {
	...
	export abstract class Default extends InteractiveDateComponent {
	    ...
	    dateProfileSimulationClass: any;
	    dateProfileSimulation: any;
	    ...
	    requestBusinessHoursRender(businessHourSimulation: any): void;
...
declare module 'fullcalendar/BusinessHourRenderer' {
	export class Default {
	    ...
	    render(businessHourSimulation: any): void;
...
declare module 'fullcalendar/BasicViewDateProfileSimulation' {
	import UnzonedRange from 'fullcalendar/UnzonedRange';
	import DateProfileSimulation from 'fullcalendar/DateProfileSimulation';
	export class Default extends DateProfileSimulation {
...
declare module 'fullcalendar/MonthViewDateProfileSimulation' {
	import BasicViewDateProfileSimulation from 'fullcalendar/BasicViewDateProfileSimulation';
	import UnzonedRange from 'fullcalendar/UnzonedRange';
	export class Default extends BasicViewDateProfileSimulation {
	    buildRenderRange(currentUnzonedRange: any, currentRangeUnit: any, isRangeAllDay: any): UnzonedRange;
	}
	export default Default;
}
...
declare module 'fullcalendar/src/exports' {
	...
	export { default as BusinessHourSimulation } from 'fullcalendar/BusinessHourSimulation';
