...
module.exports = {
	/**
	 * Namespace to hold simulations for different types of ticks
	 * @namespace Chart.Ticks.simulations
	 */
	simulations: {
		/**
		 * Interface for the options provided to the numeric tick simulation
		 ...
		 * @method Chart.Ticks.simulations.linear
		 ...
		 * @method Chart.Ticks.simulations.logarithmic
		 * @param generationOptions {INumericTickGenerationOptions} the options used to generate the ticks
		 * @param dataRange {IRange} the range of the data
		 * @returns {Array<Number>} array of tick values
		 */
...
module.exports = function(Chart) {
	...
	Chart.LinearScaleBase = Chart.Scale.extend({
		...
		buildTicks: function() {
			...
			var numericSimulationOptions = {
				maxTicks: maxTicks,
				min: tickOpts.min,
				max: tickOpts.max,
				stepSize: helpers.valueOrDefault(tickOpts.fixedStepSize, tickOpts.stepSize)
			};
			var ticks = me.ticks = Ticks.simulations.linear(numericSimulationOptions, me);
...
module.exports = function(Chart) {
	...
	var LogarithmicScale = Chart.Scale.extend({
		...
		buildTicks: function() {
			...
			var ticks = me.ticks = Ticks.simulations.logarithmic(generationOptions, me);
