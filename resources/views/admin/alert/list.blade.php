    ...
    <main id="main-container">
        ...
        <div class="content">
            ...
            <h2 class="content-heading" data-toggle="appear">
                ...
                <a href="{{ route('admin.alert.add') }}" class="btn btn-sm btn-rounded btn-success float-right" >Nueva</a>
                Alertas
            </h2>
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <div class="push">
                                ...
                                <form class="form-inline float-right" action="{{route('admin.alert.list')}}" style="padding-top: 10px;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if($q!='')
                                            <a href="{{route('admin.alert.list')}}" class="btn btn-secondary" title="Limpiar búsqueda" style="margin-left:10px"><i class="fa fa-times"></i> Limpiar búsqueda</a>
                                        @endif
                                    </div>
                            ...
                            <table class="table table-hover table-vcenter">
                                ...
                                <tbody>
                                    @foreach ($items as $i)
                                        <tr>
                                            <td>{!! $i->published==1?'<i class="fa fa-eye" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Activa"></i> Activa':'<i style="opacity:0.2" class="fa fa-eye-slash" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Inactiva"></i> Inactiva' !!}</td>
                                            <td>{{$i->title}}</td>
                                            <td>{{$i->description}}</td>
                                            {{-- <td>{{$i->getFrom()}}</td> --}}
                                            {{-- <td>{{$i->getTo()}}</td> --}}
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{{route('admin.alert.edit', ['id' => $i->id])}}" class="btn btn-sm btn-secondary js-tooltip-enabled" data-toggle="tooltip" title="Editar" data-original-title="Edit">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="{{route('admin.alert.delete', ['id' => $i->id])}}" class="btn btn-sm btn-secondary btn-delete js-tooltip-enabled" data-toggle="tooltip" title="Eliminar" data-original-title="Delete" data-id="{{ $i->id }}">
