...
@section('content')
    ...
    <div class="container">
        ...
        <h2 class="content-heading js-appear-enabled animated fadeIn" data-toggle="appear">                    
            ...
            {!! $item->id==0?'Nuevo':'Editar' !!} Escenario
        </h2>
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">                                
                                ...
                                <input type="text" class="form-control" name="factor" placeholder="" value="{{ $item->factor }}">                                    
                            </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var formInit = function() {
            ...
            var submitUrl = '{{ route('admin.scenario.patch',[ 'id' => $item->id] ) }}';
