    ...
    <main id="main-container">
        ...
        <div class="content">
            ...
            <h2 class="content-heading" data-toggle="appear">
                ...
                <a href="{{ route('admin.source.add') }}" class="btn btn-sm btn-rounded btn-success float-right" ><i class="fa fa-plus"></i></a>
                Tablas Fuente
            </h2>
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <div class="push">
                                ...
                                <form class="form-inline float-right" action="{{route('admin.source.list')}}" style="padding-top: 10px;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if($q!='')
                                            <a href="{{route('admin.source.list')}}" class="btn btn-secondary" title="Limpiar búsqueda" style="margin-left:10px"><i class="fa fa-times"></i> Limpiar búsqueda</a>
                                        @endif
                                    </div>
                                    ...
                                    @foreach ($items as $i)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{{route('admin.source.edit', ['id' => $i->id])}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Editar" data-original-title="Edit">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="{{route('admin.source.delete', ['id' => $i->id])}}" class="btn btn-sm btn-secondary btn-delete" data-toggle="tooltip" title="Eliminar" data-original-title="Delete" data-id="{{ $i->id }}">
