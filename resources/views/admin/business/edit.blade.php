...
@section('content')
    ...
    <div class="container">
        ...
        <h2 class="content-heading js-appear-enabled animated fadeIn" data-toggle="appear">                    
            ...
            {!! $item->id==0?'Nuevo':'Editar' !!} Tipo de Negocio
        </h2>

        <form name="formBusiness" method="POST" action="" aria-label="">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">                                
                                ...
                                <input type="text" class="form-control" name="alias" placeholder="" value="{{ $item->alias }}">                                    
                            </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var formInit = function() {
            var form = $('form[name="formBusiness"]');
            var submitButton = form.find('#btn-save');
            var cancelButton = form.find('#btn-cancel');
            var submitUrl = '{{ route('admin.business.patch',[ 'id' => $item->id] ) }}';
            ...
            return {
                init: function () {
                    ...
                    cancelButton.on('click', function(e){
                        ...
                        // document.location = '{{route('admin.business.list')}}';
                        window.history.back();
                        // closeModal();
                    })
