...
@section('content')
    ...
    <div class="container">
        ...
        <h2 class="content-heading js-appear-enabled animated fadeIn" data-toggle="appear">                    
            ...
            {!! $item->id==0?'Nuevo':'Editar' !!} Zona
        </h2>

        <form name="formZone" method="POST" action="" aria-label="">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var formInit = function() {
            var form = $('form[name="formZone"]');
            var submitButton = form.find('#btn-save');
            var cancelButton = form.find('#btn-cancel');
            var submitUrl = '{{ route('admin.zone.patch',[ 'id' => $item->id] ) }}';
            ...
            return {
                init: function () {
                    ...
                    cancelButton.on('click', function(e){
                        ...
                        // document.location = '{{route('admin.zone.list')}}';
                        window.history.back();
                        // closeModal();
                    })
