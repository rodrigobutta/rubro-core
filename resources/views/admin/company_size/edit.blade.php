...
@section('content')
    ...
    <div class="container">
        ...
        <h2 class="content-heading js-appear-enabled animated fadeIn" data-toggle="appear">                    
            ...
            {!! $item->id==0?'Nuevo':'Editar' !!} Tamaño de Empresa
        </h2>

        <form name="formCompanySize" method="POST" action="" aria-label="">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var formInit = function() {
            var form = $('form[name="formCompanySize"]');
            var submitButton = form.find('#btn-save');
            var cancelButton = form.find('#btn-cancel');
            var submitUrl = '{{ route('admin.company_size.patch',[ 'id' => $item->id] ) }}';
