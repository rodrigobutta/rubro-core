...
@section('content')
    ...
    <div class="container">
        ...
        <h2 class="content-heading js-appear-enabled animated fadeIn" data-toggle="appear">                    
            ...
            {!! $item->id==0?'Nuevo':'Editar' !!} Familia de Producto
        </h2>

        <form name="formFamily" method="POST" action="" aria-label="">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var formInit = function() {
            var form = $('form[name="formFamily"]');
            var submitButton = form.find('#btn-save');
            var cancelButton = form.find('#btn-cancel');
            var submitUrl = '{{ route('admin.family.patch',[ 'id' => $item->id] ) }}';
            ...
            return {
                init: function () {
                    ...
                    cancelButton.on('click', function(e){
                        ...
                        // document.location = '{{route('admin.family.list')}}';
                        window.history.back();
                        // closeModal();
                    })
