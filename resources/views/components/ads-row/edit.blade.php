            ...
            <div data-repeater-item style="display:none;">
                <div class="block block-themed">
                    ...
                    <div class="block-content">
                        ...
                        <div class="form-group">
                            <div class="form-material">
                                <textarea class="form-control listfield" name="alt" data-name="alt" rows="2" placeholder=""></textarea>
                ...
                <div data-repeater-item>
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">
                                <div class="form-material">
                                    <textarea class="form-control listfield" name="alt" data-name="alt" rows="2" placeholder="">{{ $i->fields->alt or '' }}</textarea>
                                    <label for="alt">Alt</label>
                                </div>
                            </div>
                            <div class="form-group">
