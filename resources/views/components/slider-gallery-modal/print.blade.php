<section class="component component-slider-gallery" data-component="" data-content-id="{{$id}}">
        ...
        <ul class="component-slider-gallery__slider js-slider-gallery">
            ...
            @foreach($fields->list as $i)
                ...
                <li class="component-slider-gallery__item">
                    <a data-fancybox="{{$id}}" href="{{Resizer::widen(1200,gg($i->fields->image,''))}}" class="component-slider-gallery__link">
    ...
    @else
        ...
        <ul class="component-slider-gallery__slider js-slider-gallery">
            <li class="component-slider-gallery__item">
                <a data-fancybox="gallery" href="http://clientes.agenciaego.com.ar/Consejo/dummy.gif" class="component-slider-gallery__link">
