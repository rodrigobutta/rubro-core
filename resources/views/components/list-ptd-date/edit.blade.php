            ...
            <div data-repeater-item style="display:none;">
                <div class="block block-themed">
                    ...
                    <div class="block-content">
                        ...
                        <div class="form-group">
                            <div class="form-material">
                                <input type="text" class="form-control listfield" name="date" data-name="date" placeholder="Sugerido DD/MM" value="">
                ...
                <div data-repeater-item>
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">
                                <div class="form-material">
                                    <input type="text" class="form-control listfield" name="date" data-name="date" placeholder="Sugerido DD/MM" value="{{$i->fields->date or ''}}">
                                    <label for="date">Fecha</label>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                ready: function (item) {
                    ...
                    item.find('input[data-name="image"]').formImage({
                        service: {
                            ...
                            validation: {
                                rules: [
                                    {'image': 'max:102400|dimensions:min_width=80,min_height=80'}
                                ],
                                messages: [
                                    {'image.image': 'El archivo seleccionado no es una imagen.'},
                                    {'image.mimes': 'La imagen debe ser jpeg,png,jpg,gif o svg.'},
                                    {'image.dimensions': 'La imagen debe tener al menos 80px de ancho X 80px de alto.'},
