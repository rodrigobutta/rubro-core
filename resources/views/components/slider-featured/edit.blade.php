            ...
            <div data-repeater-item style="display:none;">
                <div class="block block-themed">
                    ...
                    <div class="block-content">
                        ...
                        <div class="form-group">
                            <div class="form-material">
                                <textarea class="form-control listfield" name="title" data-name="title" rows="3" placeholder=""></textarea>
                ...
                ready: function (item) {
                    ...
                    item.find('input[data-name="image"]').formImage({
                        service: {
                            ...
                            validation: {
                                rules: [
                                    {'image': 'max:102400|dimensions:min_width=150,min_height=80'}
                                ],
                                messages: [
                                    {'image.image': 'El archivo seleccionado no es una imagen.'},
                                    {'image.mimes': 'La imagen debe ser jpeg,png,jpg,gif 150px de ancho X 80px de alto.'},
