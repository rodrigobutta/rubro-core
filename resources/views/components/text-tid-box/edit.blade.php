...
@section('componenthtml')
    ...
    <div class="form-group">
        <div class="form-material">
            <textarea class="form-control field" name="foot" rows="2" placeholder="">{{ $fields->foot or '' }}</textarea>
                ...
                ready: function (item) {
                    ...
                    item.find('input[data-name="image"]').formImage({
                        service: {
                            ...
                            validation: {
                                rules: [
                                    {'image': 'max:102400|dimensions:min_width=20,min_height=20'}
                                ],
                                messages: [
                                    {'image.image': 'El archivo seleccionado no es una imagen.'},
                                    {'image.mimes': 'La imagen debe ser jpeg,png,jpg,gif o svg.'},
                                    {'image.dimensions': 'La imagen debe tener al menos 20px de ancho X 20px de alto.'},
