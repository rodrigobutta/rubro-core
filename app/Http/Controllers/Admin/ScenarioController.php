...
class ScenarioController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $query = Scenario::orderBy('id', 'desc');
        ...
        return view('admin.scenario.list',[
            'items'=>$items,
            'q' => $request->input('q', '')
        ]);
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        $item = Scenario::find($id);

        return view('admin.scenario.edit',['item'=>$item]);
    }
    ...
    public function patch(Request $request)
    {
        ...
        $item->factor = $request->get('factor');
    ...
    public function search(Request $request)
    {
        ...
        // if($term !== '') {
            $items = Scenario::where('name', 'like', "%$term%")->take(20)->get();
